...
<head>
  ...
  <title>Grupos | Editar Grupos</title>
		            		...
		            		<div class="card card-info">
		             		 	<div class="card-header" style="background-color: #5f218c">
			              			<div class="float-right">
			                			<a href="index.php?action=grupos"><input class="btn btn-block btn-outline-warning" value="Listado de Grupos"></a>
			              			</div>
				            	...
				            	<form method="post">
				            			<?php
											...
											$editarCategoria -> editarGrupoController();
											$editarCategoria -> actualizarGrupoController();
										?>
			              		</form>
		            		</div>
		            		<!-- /.card -->
