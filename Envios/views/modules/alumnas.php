...
<head>
  ...
  <title>Alumnass | Vista Alumnas</title>
            ...
            <div class="card-header">
              <div class="float-left">
                <!--<a ><input class="btn btn-block btn-success" value="Nuevo Usuario"></a>-->
                  <a href="index.php?action=registrarAlumnas" class="btn btn-success" title= "Agregar Usuario">
                ...
                <tbody>
                  ...
                  //Vista completa de los usuarios mediante un datatable
              			$vistaAlumnas= new MvcController();
        						...
        						$vistaAlumnas -> borrarAlumnaController();
      						?>
                </tbody>
                <tfoot>
                <tr>
