...
<head>
  ...
  <title>Alumnas | Registrar Alumnas</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Registrar Alumnas</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php?action=dashboard">Home</a></li>
              <li class="breadcrumb-item active">Registrar Alumnas</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
		            		...
		            		<div class="card card-info">
		             		 	<div class="card-header" style="background-color: #954E9E">
			              			<div class="float-right">
			                			<a href="index.php?action=alumnas"><input class="btn btn-block btn-outline-warning" value="Listado de Alumnas"></a>
			              			</div>
							            ...
							            <div class="row">
							              	<div class="col-md-6">
								                ...
								                <div class="form-group">
													...
													<select class="form-control select2" type="number" name="IdGrupo" style="width: 100%;">
								                    	<?php
