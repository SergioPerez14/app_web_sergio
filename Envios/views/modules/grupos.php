...
<head>
  ...
  <title>Grupos | Vista Grupos</title>
            ...
            <div class="card-header">
              <div class="float-left">
                <!--<a ><input class="btn btn-block btn-success" value="Nuevo Usuario"></a>-->
                  <a href="index.php?action=registrarGrupo" class="btn btn-success" title= "Agregar Grupo">
                ...
                <tbody>
            			<?php
              			...
              			$vistaCategoria = new MvcController();
        						$vistaCategoria -> vistaGruposController();
        						$vistaCategoria -> borrarGruposController();
      						?>
                </tbody>
                <tfoot>
                <tr>
