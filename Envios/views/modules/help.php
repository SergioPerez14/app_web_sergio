...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <h1 class="headline " align="center" style="color: #5f218c">Error 500</h1>        

        <div class="error-content" align="center">
          <br>
          <h3><i class="fa fa-warning text" style="color: #5f218c"></i> Oops! Algo salió mal.</h3>
          <p>
            Trabajaremos para arreglar los inconvenientes.
            Mientras tanto, puede <a href="index.php?action=dashboard" style="color: #5f218c">regresar al dashboard</a>.
          </p>
        </div>
      <!-- /.error-page -->
    </section>
