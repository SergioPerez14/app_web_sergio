<?php 
  ...
  //en esta consulta se obtienen los datos de los futbolistas
  $datos_fut = $conexion->prepare('SELECT * FROM Futbolistas WHERE Id = :Id');
  ...
  if($_POST){
    ...
    //Update de los datos modificados del futbolista
    $update = $conexion->prepare(
      'UPDATE Futbolistas SET Nombre = :nombre, Dorsal = :dorsal, Posicion = :posicion, Carrera = :carrera, Email = :email WHERE Id = :id');
    ...
    echo '<script> alert("Futbolista Modificado!"); </script>';
