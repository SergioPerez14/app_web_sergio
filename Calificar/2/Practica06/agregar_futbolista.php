<?php 
  ...
  if($_POST){
    ...
    //Se insertan los datos agregados para ser otro futbolista por medio de insert
    $update = $conexion->prepare(
      'INSERT INTO Futbolistas (Nombre, Dorsal, Posicion, Carrera, Email) VALUES (:nombre, :dorsal, :posicion, :carrera, :email)');
    ...
    //Alerta de futbolista agregado que es la que confirma
    echo '<script> alert("Futbolista Agregado!"); </script>';
