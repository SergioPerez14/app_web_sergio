        ...
        <div class="section-container tabs" data-section>
          <section class="section">
            <div class="content" data-slug="panel1">
              ...
              <h5><strong>FUTBOLISTAS REGISTRADOS:</strong></h5>
              <table>
                <thead>
                  <tr>
                    <th width="200">Id</th>
                ...
                <tbody>
                 <?php
                   ...
                   $datos = $conexion->query("SELECT Id, Dorsal, Nombre, Carrera, Email, Posicion FROM Futbolistas");
                   ...
                   foreach($datos as  $fila){
                    ...
                    echo '<td><a href = "./modificar_futbolista.php?Id='.$fila['Id'].'" class="button tiny secondary"> Detalles </a></td>';
                    echo '<td><a href = "./borra_futbolista.php?Id='.$fila['Id'].'" class="button tiny secondary"> Delete </a></td></tr>';
                   }    
                ?> 
                <ul class="center button-group">
                  <li><br><a href="./agregar_futbolista.php" class="button">Registrar Nuevo</a></li>
                </ul>
                </tbody>
              </table>
            </div>
