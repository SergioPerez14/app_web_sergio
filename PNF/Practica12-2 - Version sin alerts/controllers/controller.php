	...
	public function vistaTiendasController(){
		...
		echo'<tr>
				...
				<td><center><a href="index.php?action=editarTienda&id='.$item["id_tienda"].'" class="btn btn-info" title= "Editar Tienda">
                	...
                	<a href="index.php?action=tiendas&idBorrar='.$item["id_tienda"].'" class="btn btn-danger" title= "Borrar Tienda">
                  		<i class="fa fa-trash"></i>
                	</a></center>
                </td>
                <td><center>';
                	...
                	if ($item["status"] == 0) {
						echo '   	<a href="index.php?action=tiendas&idActTienda='.$item["id_tienda"].'" class="btn btn-success" title= "Activar Tienda">
						...
						echo '   	<a href="index.php?action=tiendas&idDesactTienda='.$item["id_tienda"].'" class="btn btn-danger" title= "Desactivar Tienda">
