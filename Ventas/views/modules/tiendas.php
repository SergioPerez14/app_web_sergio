            ...
            <div class="card-header">
              <div class="float-left">
                <!--<a ><input class="btn btn-block btn-success" value="Nuevo Usuario"></a>-->
                  <a href="index.php?action=registrarTienda" class="btn btn-success" title= "Nueva Tienda">
                ...
                <tbody>
                  ...
                  //Vista completa de los usuarios mediante un datatable
              			$vistaTienda = new MvcController();
        						...
        						$vistaTienda -> borrarTiendaController();
                    $vistaTienda -> entrarTiendaController();
                    $vistaTienda -> activarTiendaController();
