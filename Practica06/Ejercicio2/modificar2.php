<?php
	...
	//Consulta para traer los datos de la tabla basquetbol dependiendo del id de jugador
	        ...
	        <div class="section-container tabs" data-section>
	          <section class="section">
	            <div class="content" data-slug="panel1">
	              ...
	              <label><font color=ffffff>ID:  </label><?php //Se imprimen los valores del resultado de la consulta ?>
