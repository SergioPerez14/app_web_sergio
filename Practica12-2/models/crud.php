...
class Datos extends Conexion{
	...
	public function vistaProductosVendModel($tabla, $tienda){

		$stmt = Conexion::conectar()->prepare("SELECT id_producto_vendido, t.id_producto, t.cantidad, t.total, t.id_venta, p.preciounitario FROM $tabla as t INNER JOIN productos as p on p.id_producto = t.id_producto INNER JOIN ventas as v on t.id_venta = v.id_venta WHERE t.id_tienda = $tienda");	
		$stmt->execute();
