...
/*
	...
	#ACTUALIZAR STOCK - RESTA DE VENTA DE PRODUCTO
	#------------------------------------
	...
	#------------------------------------
	public function restarStockProductosModel($datosModel, $tabla){
	...
	public function seleccionarUltimoProdVendidoModel($tabla,$tienda){
		...
		$stmt = Conexion::conectar()->prepare("SELECT id_producto_vendido FROM $tabla WHERE id_tienda = $tienda ORDER BY id_producto_vendido DESC LIMIT 1");	
		$stmt->execute();
	...
	public function seleccionarIDProductoModel($tabla,$tienda){

		$stmt = Conexion::conectar()->prepare("SELECT pv.id_producto as 'id_producto' FROM $tabla as pv INNER JOIN ventas as v on pv.id_venta = v.id_venta and pv.id_tienda = $tienda ORDER BY pv.id_producto_vendido DESC LIMIT 1");	
		$stmt->execute();
