	  ...
	  <body>
	    ...
	    <div class="row">
	      <div class="large-12 columns">
	          ...
	          <h4><b><font color=000000><center>Modificar Producto</center></font></b></h4>
	        ...
	        <div class="section-container tabs" data-section>
	          <section class="section">
	            <div class="content" data-slug="panel1">
	              ...
	              <br>
	              <label><font color=ffffff>Descripcion: </label>
	              <input type="text" name="des" value='<?php echo $result[0]['descripcion']; ?>'>
  	              <br>
	              <label><font color=ffffff>Precio Unitario: </label>
	              <input type="text" name="precio" value='<?php echo $result[0]['preciounitario']; ?>'>
	              <br>
	              <center><input type="submit" name="editar" style="background-color: #c48301;" value="Editar" class="button" onclick="mensaje()"></center>
	              <center><a href="./productos.php" class="button">Volver al listado</a></center>
	              </form>
	            </div>
	          </section>
	        </div>
